...
#               SibShip8602 StatusRA
# Down              3048        0
# NotSig            472536   484136
# Up                8552        0
# 
...
DMPs_Status <- topTable(fit.reduced, coef = 'SibShip63', num=Inf,  genelist=ann450kSub)
DMPs_4 <- topTable(fit.reduced, coef = 2, num=Inf,  genelist=ann450kSub)
head(DMPs_Status)

write.csv(DMPs_Status,"~/Desktop/RP2/twin_methylation/RP2DNAmTwin_DMPsDiseaseStatusMales.csv", row.names = FALSE)